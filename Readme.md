...
- home assistant switches: (*optional, see [config flags](https://github.com/fortalbrz/aquarioino/blob/main/README.md#configuration-flags)*)
  ...
  - heater switch
  - cooler fan switch
  - sump / "drain" / "water reposition" pumps switches 
...
| FEEDING_AS_PUSH_BUTTON              | true               | true for feeding using a external feeder push button or false for use a step motor as feeder (see bellow)    |
...
|---------------------|--------------------------------------------|------------------------------|
| Temperatura da agua | sensor.aquarioino_water_temperature_sensor | water temperature (celsius)  |
| pH da agua          | sensor.aquarioino_water_ph_sensor          | water pH                     |
| Temperatura da ar   | sensor.aquarioino_air_temperature_sensor   | air temperature (celsius)    |
| Umidade do ar       | sensor.aquarioino_air_humidity_sensor      | air humidity (%)             |
| Pressao Atmosférica | sensor.aquarioino_air_pressure_sensor      | atmospheric pressure (mPa)   |
| Estado do Aquario   | sensor.aquarioino_state_sensor             | running / off / pwc / manual |
| Previsao do Tempo   | sensor.aquarioino_weather_forecast_sensor  | local weather forecasting    |

## MQTT switches and buttons

| Name                 | uid                                      | description                                           |
|----------------------|------------------------------------------|-------------------------------------------------------|
| Aquario Luz          | light.aquarioino_lights                  | lights switch (on/off)                                |
| Aquario Aquecedor    | switch.aquarioino_heater_switch          | heater switch (on/off)                                |
| Aquario Cooler       | switch.aquarioino_cooler_switch          | cooler switch (on/off)                                |
| Aquario Filtro UV    | switch.aquarioino_uv_filter_switch       | UV filter switch (on/off)                             |
| Aquario Timers       | switch.aquarioino_timers_switch          | timers switch (enables/disables timers)               |
| Alimentar            | button.aquarioino_feed_button            | feed the fishes button                                |
| Desligar Aquario     | button.aquarioino_turn_off_button        | turn off button (press "restart" to go back)          |
| Reiniciar Aquario    | button.aquarioino_restart_button         | restart button                                        |
| TPA                  | button.aquarioino_pwc_button             | start automated partial water change (PWC) button     |
| Limpeza Manual       | button.aquarioino_manual_cleaning_button | "manual cleaning" button (press "restart" to go back) |
| Salvar Configuracoes | button.aquarioino_save_button            | "save" configurations on EEPROM                       |
...
| Name               | uid                               | description                             |
|--------------------|-----------------------------------|-----------------------------------------|
| Temperatura maxima | number.aquarioino_temperature_max | high water temperature alarm  (celsius) |
| Temperatura minima | number.aquarioino_temperature_min | low water temperature alarm  (celsius)  |
| pH maximo          | number.aquarioino_ph_max          | high pH alarm                           |
| pH minimo          | number.aquarioino_ph_min          | low pH alarm                            |
